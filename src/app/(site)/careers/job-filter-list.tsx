          ...
          jobsByCountry.map(countryGroup => (
            ...
            >
              ...
              <div className="flex flex-wrap items-baseline gap-2 border-b border-slate-100 pb-4">
                <h3 className="flex items-center gap-2 text-2xl font-bold text-[#0A1628]">
                  <Globe2
                    className="h-6 w-6 text-[#176FEB]"
                    aria-hidden="true"
                  />
                    ...
                    <div className="space-y-7 pl-7 border-l-2 border-slate-100 ml-2">
                      {regionGroup.cities.map((cityGroup) => (
                        <div key={cityGroup.city}>
                          <h5 className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#0A1628]/65 mb-3">
                            {cityGroup.city}
                          </h5>
                            ...
                            {cityGroup.roles.map((role) => (
                              <li key={role.slug}>
                                <Link
                                  ...
                                  scroll={true}
                                  className="group flex flex-col gap-2 rounded-xl border border-slate-100 bg-slate-50/60 p-4 transition-all hover:-translate-y-0.5 hover:border-[#176FEB]/40 hover:bg-white hover:shadow-md md:flex-row md:items-center md:justify-between md:gap-6 md:p-5"
                                >
                                  <div className="min-w-0 flex-1">
                                    <h6 className="text-base font-bold text-[#176FEB] transition-colors">
                                      {role.title}
                                    </h6>
                                  ...
                                  <span className="inline-flex shrink-0 items-center gap-1.5 text-sm font-bold text-[#0A1628] transition-colors group-hover:text-[#176FEB]">
                                    View role
