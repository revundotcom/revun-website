...
export const metadata: Metadata = {
  ...
  description:
    'Compare Revun against AppFolio, Buildium, DoorLoop, SingleKey, liv.rent, and more. See feature-by-feature breakdowns for property managers across Canada and the US.',
