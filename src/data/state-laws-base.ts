...
export interface StateLocalData {
  population: string
  renterShare: string
  medianRent: string
  metros: string[]
...
export const baseStateLaws: Record<string, StateLaw> = {
  'california-landlord-tenant-law': {
    ...
    localData: {
      ...
      renterShare: '~44% of households rent',
      medianRent: '~$2,100 (2BR)',
      metros: ['Los Angeles', 'San Francisco', 'San Diego', 'San Jose', 'Sacramento'],
      marketNote:
  ...
  'texas-landlord-tenant-law': {
    ...
    localData: {
      ...
      metros: ['Houston', 'Dallas', 'Austin', 'San Antonio', 'Fort Worth'],
      marketNote:
