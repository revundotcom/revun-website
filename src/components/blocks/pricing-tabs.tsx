...
const TIERS: Tier[] = [
  {
    ...
    annualPrice: '$0',
    unit: '/mo',
    description: 'Free for 1-2 units. The essentials to manage your own property.',
    features: [
      'Leasing: listing, showings, applications',
      'Payments: rent collection (ACH)',
      'Maintenance: request intake and tracking',
      'Communications: tenant chat and email',
      'Accounting: basic income/expense log',
      'Compliance: standard lease templates',
      'Mobile app access',
  ...
  },
  {
    ...
    annualPrice: '$23',
    unit: '/unit/mo',
    description: 'For property managers and growing portfolios (3-100 units).',
    features: [
      'Everything in Self-Managing Owner',
      'Leasing: automation, screening, renewals',
      'Payments: ACH, credit card, Interac',
      'Maintenance: vendor dispatch and SLAs',
      'Communications: SMS, email campaigns',
      'Accounting: owner statements, reconciliation',
      'Compliance: province/state workflows',
      'Data migration assistance',
      'Guided onboarding (2 sessions)',
  ...
  },
  {
    ...
    annualPrice: '$39',
    unit: '/unit/mo',
    description: 'For brokerages, leasing companies, and PMCs (25-500 units).',
    popular: true,
    features: [
      'Everything in Operator',
      'Leasing: multi-agent pipeline, offer management',
      'Payments: split disbursements, trust accounting',
      'Maintenance: proof-of-work, photo/video logs',
      'Communications: telephony routing, auto-replies',
      'Accounting: multi-entity reporting, GL sync',
      'Compliance: document vault, audit trail',
      'Full data migration included',
      'Dedicated onboarding manager',
      'API access and integrations',
      'Custom permissions and team roles',
      'Rent guarantee (optional add-on)',
    ],
    cta: 'Start Free Trial',
    ctaHref: '/signup/',
    bg: 'bg-[#E8F2FE]',
  },
  {
    ...
    monthlyPrice: 'Custom',
    unit: '',
    description: 'For large operators, REITs, and asset managers (500+ units).',
    features: [
      'Everything in Brokerage & Leasing',
      'Leasing: custom workflows, bulk operations',
      'Payments: multi-currency, institutional banking',
      'Maintenance: fleet management, capital planning',
      'Communications: branded portals, white-label',
      'Accounting: ERP integration, fund-level reporting',
      'Compliance: governance config, security audit',
      'White-glove onboarding and phased rollout',
      'Dedicated success team and SLA guarantees',
      'Custom API and infrastructure',
      'Rent guarantee included',
